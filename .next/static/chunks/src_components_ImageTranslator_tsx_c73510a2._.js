...
function ImageTranslator({ imageFile, onTranslationComplete, onCancel }) {
    ...
    const [lastTranslatedImageUrl, setLastTranslatedImageUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    // 이미지 로드
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageTranslator.useEffect": ()=>{
            const autoGenerateTranslatedImage = {
                "ImageTranslator.useEffect.autoGenerateTranslatedImage": async ()=>{
                    // 번역된 영역이 있고, 모든 번역이 완료된 경우에만 실행
                    const translatedSelections = selections.filter({
                        "ImageTranslator.useEffect.autoGenerateTranslatedImage.translatedSelections": (sel)=>sel.translatedText && !sel.isTranslating
                    }["ImageTranslator.useEffect.autoGenerateTranslatedImage.translatedSelections"]);
                    if (translatedSelections.length === 0) return;
                    // 번역 중인 영역이 있으면 대기
                    if (selections.some({
                        "ImageTranslator.useEffect.autoGenerateTranslatedImage": (sel)=>sel.isTranslating
                    }["ImageTranslator.useEffect.autoGenerateTranslatedImage"])) return;
                    // 자동으로 번역된 이미지 생성
                    try {
            ...
            }["ImageTranslator.useEffect.autoGenerateTranslatedImage"];
...
_s(ImageTranslator, "f3k2rL7rEiu6/gQPGHS6cu7P04o=");
_c = ImageTranslator;
var _c;

...
function CategorySection() {
    ...
    const fetchPosts = async (category)=>{
        try {
            setLoading(true);
            const url = category && category !== 'ALL' ? `/api/posts?category=${category}&limit=20` : `/api/posts?limit=20`;
...
_s(CategorySection, "+XcsZIaIR4ali9g2xcPpaDfpd7w=");
_c = CategorySection;
var _c;
...
//# sourceMappingURL=_581b3605._.js.map
...
"[project]/src/lib/imageTranslator.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "translateImageText": (()=>translateImageText)
});
...
// GPT로 번역
async function translateWithGPT(koreanText) {
    try {
...
async function translateImageText(imageBuffer) {
    try {
        console.log('Starting image translation...');
        // 1. 단순하게 원본 이미지로만 OCR 수행
        const worker = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tesseract$2e$js$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createWorker('kor', 1, {
        ...
        if (koreanBlocks.length === 0 && ocrData && typeof ocrData === 'object' && 'words' in ocrData) {
            ...
            if (koreanWords.length > 0) {
                ...
                for (const group of groupedWords){
                    ...
                    console.log('Korean text block found:', combinedText, 'at position:', {
                        x0: minX,
                        y0: minY,
                        x1: maxX,
                        y1: maxY
        ...
        const processedImageBuffer = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$sharp__$5b$external$5d$__$28$sharp$2c$__cjs$29$__["default"])(imageBuffer).png().toBuffer();
        // 5. 변환된 이미지로 Canvas 작업
        const originalImage = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$canvas__$5b$external$5d$__$28$canvas$2c$__cjs$29$__["loadImage"])(processedImageBuffer);
        const canvas = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$canvas__$5b$external$5d$__$28$canvas$2c$__cjs$29$__["createCanvas"])(originalImage.width, originalImage.height);
        ...
        // 8. 적당한 품질로 최적화
        const optimizedBuffer = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$sharp__$5b$external$5d$__$28$sharp$2c$__cjs$29$__["default"])(canvasBuffer).jpeg({
            quality: 85
        }).toBuffer();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__343d7da4._.js.map
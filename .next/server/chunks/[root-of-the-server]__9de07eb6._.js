...
;
// 새로운 Prisma 인스턴스 생성
const prismaLocal = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
async function POST(request) {
    try {
        ...
        console.log('Prisma client status:', typeof prismaLocal);
        ...
        // 게시글 생성
        const post = await prismaLocal.post.create({
            data: {
                title,
...
async function GET(request) {
    try {
        ...
        // 새로운 연결로 테스트
        console.log('🔗 Testing new Prisma connection...');
        await prismaLocal.$connect();
        console.log('✅ Database connection successful');
        // 매우 간단한 쿼리로 테스트
        const totalCount = await prismaLocal.post.count();
        ...
        // 먼저 카테고리 필터 없이 모든 게시글 조회
        console.log('🔍 Trying simple findMany without category filter...');
        const posts = await prismaLocal.post.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            skip,
        ...
        console.log('✅ Simple query successful, posts found:', posts.length);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9de07eb6._.js.map